# Advice on Following an Academic Path

This document contains resources and notes that I've gathered about following an academic path (from being a graduate student and postdoctoral fellow to faculty positions). I should preface this by stating this advice is geared towards an applied statistics/genomics field, but I think most of it applies to a broader set of fields. Pull requests and comments are welcomed! 

## Podcasts

* [The Effort Report](http://effortreport.libsyn.com) - Talks about what it's like to have an academic career
...
Here is some advice I got when applying for a postdoc: 
...
* Read about the faculty's interests and if you have ideas, be sure to propose ideas on projects that you would like to work on and how it relates to the faculty's interests. Send your CV and a cover letter explicitly stating why you are a good fit for their lab/group. 
...
* Prepare 3-5 reference letters to be sent emailed (or mailed via snail mail sometimes) directly to the university or institution. 
...
* You want to show that you are the best candidate. It is typically 1-2 days long. You will have many, many 15-30 mins meetings with faculty. Read up on the faculty by reviewing their profiles online. You will have meetings with junior and senior faculty. Ask the junior faculty if the expectations of promotion were clearly explained to them? Do they get annual feedback on what to improve/focus on in the promotion evaluation? 
* You will typically give a one hour seminar summarizing your research thus far and discussing your future research plans. 
* If this is mostly a teaching position, you may be asked to teach a class on a specific topic proposed by the hiring committee. If this is mostly a research position, you may be asked to give a *chalk talk*. The chalk talk may or may not include slides (be sure to ask the university or institution). 
...
* There will be at least one meeting scheduled with the department head/chair.
* You will probably go out to dinner with a set of faculty on the hiring committee. At dinner, definitely be yourself. These are potential colleagues of yours. You want to know that you can get along with them and they want to know if they can get along with you. 
...
* **Two most important parts to keep in mind**: An impressive CV or set of publications lands you the job interview. An impressive job talk lands you the job offer.
...
* Keep your CV up-to-date and accurate. No gaps. Get in touch with referees sooner rather than later. 
...
* Be prepared to explain what you've done up until now (PhD, postdoc? most recent work?) 
* Be prepared to explain what motivates you. Have a good sense of what your ideal job is. 
* Figure out the system for academic rank at the institution or university. For example most people at the Harvard institutions start out as instructors (not Assistant Professors). Read about the promotion metrics online if available. 
* Look at the publications of members of your lab 1-2 years ahead of you and see where the bar is set. 

#### During the faculty interview

Things you may be asked: 

* "How come you only have 1 journal manuscript?". You could explain how the project was given to you as a graduate student or the project didn't really work out. Afterwards it is important to state what you learned from the project or how you moved forward.
...
* "Tell me about your experience in teaching. What would you like to teach?" You could talk about how you've taught in classroom and mentored PhD students. Give examples of the types of subjects. 
* "How would you see your career progressing over the next 3-5 years?" State research focus. state funding goals focus (e.g. R01).
* "What are your weaknesses technically? how can you bolster those weaknesses?" For example, you could talk about how you have this inability to let go a project that won't succeed and give an example.
* "Are there any technical skills you want to build up and enhance you effectiveness and funding capability?"
* "How you would handle mentoring (e.g. undergraduates, graduate students)?" For example, for postdocs, it may be important to you to build a relationship, define the goals of the lab and let the postdoc innovate & sense of being command of project to promote independence. 

Things you may want to ask the chair and faculty: 

* Are you happy? What is the institutional outlook on work/life balance? Are there opportunities for building a life or family? Is there a gender mix in the faculty? Are there resources for helping young families? How much time do you spend on research versus other things (e.g. teaching, service to the department and/or university)? 
...
* The chair makes a lot of decisions. Get a sense of what the chair?s academic value?s are.
...
* Keep in mind that the faculty you are scheduled meet with has either (1) never read your CV (most likely) or (2) quickly scanned your CV 10 minutes before the meeting (if you're lucky). There will be the 1-2 people who have spent some serious time looking at your CV and will ask some **very insightful** questions. Be prepared to succinctly summarize your work and research interests in a way that is relevant to the department/university that you are interviewing at. 
...
* Keep in mind, you can ask for just about anything. For example, a parking spot (if they are hard to come by), a spot in the daycare on campus for your child, supplemental housing support (if you are moving to a city with expensive housing), proximity of lab space to office, etc. 
...
Here are a few extra tips from various seminars and workshops that I have attended over the past few years. 
